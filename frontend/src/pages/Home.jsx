      ...
      <div className="landing-page">
        ...
        <div className="introduce">
          ...
          <div className="intro-box-container">
            ...
            >
              <h3>이런 분들에게 추천드려요</h3>
              <ul>
                <li>누군가에게 털어놓고 싶지만, 익명성이 보장되는 공간을 원하시는 분</li>
                <li>학교·직장 등 가까운 관계에서는 말하기 어려운 고민을 가지고 있는 분</li>
                <li>비슷한 경험을 가진 사람들과 공감하고 교류하고 싶은 분</li>
                <li>멘탈 케어 또는 감정 관리가 필요하지만 부담 없는 접근을 원하시는 분</li>
        ...
        <div className="why">
          ...
          <div className="why-box">
            {["익명 기반 안전한 환경", "신고·차단·필터링 시스템", "전문가 가이드 기반 운영", "심리적 부담 없이 접근 가능한 UI"].map(
              (text, i) => (
                <motion.div
                  className="w-box"
                  key={i}
        ...
        >
          <p>
            DRC의 상담 기능은 전문 의료 서비스를 대체하지 않습니다. 긴급한 도움이 필요하다면 가까운 상담센터 또는 도움 기관에 연락하세요.
          </p>
